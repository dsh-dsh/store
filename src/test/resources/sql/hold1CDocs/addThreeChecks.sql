...
(1, 2, null, '2022-03-16T02:00:00.000', 'CHECK_DOC', 1, B'0', B'1', 1, 3, 1, null, 3, null, B'0', 1),
(2, 2, null, '2022-03-16T02:00:00.001', 'CHECK_DOC', 1, B'0', B'1', 1, 3, 1, null, 3, null, B'0', 1),
(3, 2, null, '2022-03-16T02:00:00.002', 'CHECK_DOC', 1, B'0', B'1', 1, 3, 1, null, 3, null, B'0', 1);

insert into check_kkm_info
(amount_received, cash_register_number, check_id, check_number, date_time, guest_number, is_delivery,
is_kkm_checked, is_payed, check_payment_type, is_return, table_number, waiter)
values
(1000.0, 63214823871, 1, 65469, '2022-03-16T02:00:00.000', 1, B'1', B'1', B'1', 'CARD_PAYMENT', B'1', 12, 'Официант 10'),
(1000.0, 63214823871, 2, 65469, '2022-03-16T02:00:00.001', 1, B'1', B'1', B'1', 'CASH_PAYMENT', B'1', 12, 'Официант 10'),
(1000.0, 63214823871, 3, 65469, '2022-03-16T02:00:00.002', 1, B'1', B'1', B'1', 'QR_PAYMENT', B'1', 12, 'Официант 10');

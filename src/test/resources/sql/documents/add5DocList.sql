...
(id, author_id, base_document_id, date_time, doc_type, individual_id, is_hold, is_payed, number, project_id,
supplier_id, recipient_id, storage_from_id, storage_to_id, is_deleted, d_type)
values (2, 2, null, '2022-03-16T08:30:36.395', 'INVENTORY_DOC', null, B'1', B'1', 1, 3, 1, 1, null, 3, B'0', 1);
...
(id, author_id, base_document_id, date_time, doc_type, individual_id, is_hold, is_payed, number, project_id,
supplier_id, recipient_id, storage_from_id, storage_to_id, is_deleted, d_type)
values (3, 2, null, '2022-03-16T09:30:36.395', 'POSTING_DOC', null, B'1', B'1', 1, 3, null, 1, null, 3, B'0', 1);
...
(id, author_id, base_document_id, date_time, doc_type, individual_id, is_hold, is_payed, number, project_id,
supplier_id, recipient_id, storage_from_id, storage_to_id, is_deleted, d_type)
values (4, 2, null, '2022-03-16T10:30:36.395', 'RECEIPT_DOC', null, B'1', B'1', 1, 3, 1, 1, null, 3, B'0', 1);
...
(id, author_id, base_document_id, date_time, doc_type, individual_id, is_hold, is_payed, number, project_id,
supplier_id, recipient_id, storage_from_id, storage_to_id, is_deleted, d_type)
values (5, 2, null, '2022-03-16T11:30:36.395', 'REQUEST_DOC', null, B'1', B'1', 1, 3, 1, 1, null, 3, B'0', 1);

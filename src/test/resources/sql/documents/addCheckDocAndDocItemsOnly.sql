...
values (1, 2, null, '2022-03-16T06:30:36.395', 'CHECK_DOC', 1, B'0', B'1', 1, 3, 1, null, 3, null, B'0', 1);

insert into document_item
(id, discount, item_id, document_id, price, quantity, quantity_fact)
values
(1, 0.0, 1, 1, 50.0, 1.0, 0.0),
(2, 0.0, 2, 1, 100.0, 2.0, 0.0),
(3, 0.0, 3, 1, 150.0, 3.0, 0.0);
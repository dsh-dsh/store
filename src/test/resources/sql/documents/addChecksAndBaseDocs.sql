...
values
(1, 2, null, '2022-04-16T01:00:00.001', 'CHECK_DOC', 1, B'1', B'1', 1, 3, 1, null, 3, null, B'0', 1),
(2, 2, null, '2022-04-16T01:00:00.002', 'CHECK_DOC', 1, B'1', B'1', 1, 3, 1, null, 3, null, B'0', 1),
(3, 2, null, '2022-04-16T01:00:00.003', 'CHECK_DOC', 1, B'1', B'1', 1, 3, 1, null, 3, null, B'0', 1),
(4, 2, null, '2022-04-16T01:00:00.004', 'RECEIPT_DOC', null, B'1', B'1', 1, 3, 1, 1, null, 3, B'0', 1),
(5, 2, null, '2022-04-16T01:00:00.005', 'WRITE_OFF_DOC', null, B'1', B'1', 1, 3, 1, 1, 3, null, B'0', 1);

update document set base_document_id = 5 where id < 4;
update document set base_document_id = 4 where id = 5;

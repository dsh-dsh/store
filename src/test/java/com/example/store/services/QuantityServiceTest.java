...
public class QuantityServiceTest {
    ...
    void setQuantitiesTest() {
        ...
        List<QuantityDTO> dtoList = List.of(
                getQuantityDTO("NET", 4f, date.toString()),
                getQuantityDTO("GROSS", 2f, date.toString()));
    ...
    void updateQuantitiesTest() {
        ...
        List<QuantityDTO> dtoList = List.of(
                getQuantityDTO("NET", 4f, date.toString()),
                getQuantityDTO("GROSS", 1f, date.toString()));
    ...
    private QuantityDTO getQuantityDTO(String type, float quantity, String date) {
